...
PRINT 'Created function fn_RemoveDiacritics with proper SET options';
...
-- Create indexes
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Products_NameNormalized')
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'IX_Products_DescriptionNormalized')
BEGIN
