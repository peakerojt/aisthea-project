...
import { CartItemResponse } from '@/common/services/cart.service';
...
interface CartDrawerProps {
    ...
    onClose: () => void;
    onCheckout: () => void;
    setView: (view: ViewState) => void; // Added from HEAD
    cartItems: CartItem[]; // Added from HEAD
    updateQuantity: (id: string, newQuantity: number) => void; // Added from HEAD
    removeItem: (id: string) => void; // Added from HEAD
}
