                    ...
                    <div className="absolute bottom-4 right-4 flex gap-2 pointer-events-auto z-20">
                        {validImages.slice(0, 3).map((image, index) => (
                            <button
                                ...
                                className={`w-12 h-12 sm:w-16 h-16 rounded-md overflow-hidden border-2 transition-all duration-300 backdrop-blur-sm cursor-pointer ${index === currentIndex
                                    ? 'border-primary scale-110 shadow-lg shadow-black/50'
                                    : 'border-white/20 hover:border-white/50 bg-black/20'
                                    }`}
                            >
                                <img
