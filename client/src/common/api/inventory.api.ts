...
export const inventoryApi = {
    ...
    fetchSummary: () => api.get<InventorySummaryResponse>('/api/inventory/summary'),

    fetchMovements: (variantId: number, params: { page: string; limit: string }) =>
        api.get<StockMovementsResponse>(`/api/inventory/${variantId}/movements`, { params }),
};
